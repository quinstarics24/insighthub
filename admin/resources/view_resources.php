                ...
                <table class="table table-bordered table-striped align-middle">
                    ...
                    <?php while($row = $result->fetch_assoc()): ?>
                        <tr>
                            ...
                            <td>
                                <?php
                                if ($row['file']) echo '<a href="uploads/'.htmlspecialchars($row['file']).'" target="_blank">File</a>';
                                elseif ($row['link']) echo '<a href="'.htmlspecialchars($row['link']).'" target="_blank">Link</a>';
                                else echo '-';
                                ?>
                            </td>
                            <td><?php echo $row['created_at']; ?></td>
                            <td>
                                <a href="edit_resource.php?id=<?php echo $row['id']; ?>" class="btn btn-sm btn-primary">Edit</a>
